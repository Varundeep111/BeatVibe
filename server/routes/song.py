...
# Configuration       
cloudinary.config( 
    cloud_name = "dnnhxzcx8", 
    api_key = "827514223252757", 
    api_secret = "6MDBjARurdOlgKuXNCMEEKsK5xI", # Click 'View Credentials' below to copy your API secret
    secure=True
)
...
def favorite_song(song:FavoriteSong,
   ...
   if fav_song:
     ...
     new_fav = Favorite(id = str(uuid.uuid4()),song_id = song.song_id,
                        user_id = user_id)
     db.add(new_fav)
     db.commit() 
     return  {'message' : True}                
